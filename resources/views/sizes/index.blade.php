                            ...
                            <thead>
                                <tr >
                                    <th class="datatable-cell datatable-cell-sort">
                                        <span style="width: 250px;">Ancho (cm)</span>
                                    </th>

                                    <th class="datatable-cell datatable-cell-sort">
                                        <span style="width: 250px;">Alto (cm)</span>
                                    </th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="width" v-model="width" @keypress="isNumberDot($event)">
                            <small v-if="errors.hasOwnProperty('width')">@{{ errors['width'][0] }}</small>
                        </div>
                    
                        <div class="form-group">
                            <label for="height">Alto</label>
                            <input type="text" class="form-control" id="height" v-model="height" @keypress="isNumberDot($event)">
    ...
    <script>
        ...
        const app = new Vue({
            ...
            methods:{
                ...
                store(){
                    this.loading = true
                    axios.post("{{ url('size/store') }}", {height: this.height, width: this.width})
                    .then(res => {
                        this.loading = false
